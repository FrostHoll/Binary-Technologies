...
namespace BinaryTechnologies.Tiles
{
    public class BossRelic : ModTile
    {
        ...
        public const int VerticalFrames = 1; // num of relics

        public Asset<Texture2D> RelicTexture;

        public virtual string RelicTextureName => "BinaryTechnologies/Tiles/TechnoSphereRelic";

        public override string Texture => "BinaryTechnologies/Tiles/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeable.TechnoSphereRelic>();
					break;
			}
